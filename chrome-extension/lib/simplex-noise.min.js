/**
 * simplex-noise — fast 2D simplex noise
 * Minimal standalone implementation for Chrome extension (no module bundler).
 * Based on Stefan Gustavson's SimplexNoise algorithm.
 */
(function(global) {
  'use strict';
